...
#if you ask for time, time display
root = Tk()
root.title("Digital Clock")

#place holder for the clock
def getTime():
    timeFormart = strftime('%H:%M:%S %p')
    clock.config(text=timeFormart)
    clock.after(200, getTime)
#designing the clock's font, size, colour, alighnment
clock = Label(root, font=( "ds-digital", 100), bg = "black", fg = "white")
